const key ='6397ecd8960973d5d81a6d221d982db1';
...
async function showWeather(lat,lon,name,state){
    ...
    document.getElementById("degrees").innerHTML = temp +"°F";
    document.getElementById("feelsLikeValue").innerHTML = feelslike +'<span> °F</span>';
